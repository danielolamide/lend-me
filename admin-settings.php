...
<body>
    ...
    <main>
        ...
        <form>
           <div class="center-align white container" id="admin-settings-container">
                <div class="row">
                ...
                <div class="row">
                    <div class="col s5 m5 l5">
                            <span style="color:#C5C5C3; font-size:18px;">Change Password</span>&nbsp;<i class="grey-text material-icons">edit</i>
                    </div>
                    <div class="input-field col s7 m7 l7" id="email-field-settings">
                        <input type="password" name="admin-pass" class="validate" value="123456">
                    </div>
                </div>
                <div class="row">
                    <div class="col s5 m5 l5">
                            <span style="color:#C5C5C3; font-size:18px;">Re-type Password</span>&nbsp;<i class="grey-text material-icons">edit</i>
                    </div>
                    <div class="input-field col s7 m7 l7" id="email-field-settings">
                        <input type="password" name="admin-pass-retype" class="validate" value="123456">
                    </div>
                </div>
                <div class="row">
                    <div class="col s5 m5 l5">
